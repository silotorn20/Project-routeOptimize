...
const SaveModal = ({ isOpen, onClose, handleSaveTrip }) => {
                        ...
                        <div className="px-6 py-4">
                            <div className="grid gap-5 grid-cols-[repeat(auto-fit,minmax(0,1fr))]">
                                <button type="button"
                                    ...
                                    className={`${styles.btn_saveModal} inline-flex items-center justify-center`}>
                                    <span className="flex items-center gap-1">
                                        <span className={styles.text_saveModal}>
                                            Save
                                        </span>
                                    </span>
                                </button>
